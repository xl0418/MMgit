...
for(i in 1:total) {
  ...
  simul_plot <- qplot(time, values, data = sub_df,group = ind, colour = ind, geom = "path") +
    ...
    geom_hline(yintercept = 40, colour = "red", linetype = "longdash")
...
dev.off()
# ffmpeg -r 10 -i /Users/mac/Dropbox/R/animation/images/Mig_sim_%02d.png -b:v 50M /Users/mac/Dropbox/R/animation/Mig_4_sim_video_each_loc.mp4
